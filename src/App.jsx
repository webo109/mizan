...
const TR={
  en:{
    ...
    dash:{freeToSpend:'In My Pocket',totalIncome:'Income',totalSpent:'Spent',totalSaved:'Saved',alerts:'Budget Alerts',recentTx:'Recent',noAlerts:'All budgets on track 👍',mainGoal:'Main Goal',progress:'progress',toGo:'to go',seeAll:'See all →'},
